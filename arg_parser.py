...
def parse_args():
    ...
    parser.add_argument("--beta", default=0.9, type=float, help="ponderation for gradients mixture")
    parser.add_argument("--quantile", default=0.5, type=float, help="quantile for SalUn")
